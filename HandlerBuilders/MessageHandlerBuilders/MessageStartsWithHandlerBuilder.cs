...
{
    public sealed class MessageStartsWithHandlerBuilder<TLocalizationModel> where TLocalizationModel : class, new()
    {
        ...
        internal MessageStartsWithHandlerBuilder(List<MessageExpressionHandler<TLocalizationModel>> expressionList,
        ...
        public Func<Message, TLocalizationModel, Task> this[string text, Verify verified = Verify.Unchecked, StringComparison comparison = StringComparison.Ordinal]
        {
            set
            {
                _expressionList.Add(new MessageExpressionHandler<TLocalizationModel>(m =>
                {
                    ...
                    return m.Type == MessageType.Text && m.Text.StartsWith(text, comparison);
                }, value, verified));
            }
        }
