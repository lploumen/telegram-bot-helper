...
namespace Telegram.Bot.Helper.Handlers
{
    ...
    {
        public readonly Expression<Func<TLocalizationModel, string>> Message;
        public readonly Func<Message, Verify, TLocalizationModel, Task> Callback;
        public readonly Verify Verified;

        internal TextMessageHandler(Func<Message, Verify, TLocalizationModel, Task> callback, Expression<Func<TLocalizationModel, string>> message, Verify verified)
        {
            Message = message;
            Callback = callback;
            Verified = verified;
